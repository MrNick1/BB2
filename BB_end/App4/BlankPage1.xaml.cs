...
namespace App4
{
    ...
    public sealed partial class BlankPage1 : Page
    {
        ...
        {
            newvar1 = (int[,])Application.Current.Resources["newvar1"];
            newvar2 = (int[,])Application.Current.Resources["newvar2"];
            newvar3 = (int[,])Application.Current.Resources["newvar3"];
            newvar4 = (int[,])Application.Current.Resources["newvar4"];

            i_max1 = (int)Application.Current.Resources["i_max1"];
            i_max2 = (int)Application.Current.Resources["i_max2"];
            i_max3 = (int)Application.Current.Resources["i_max3"];
            i_max4 = (int)Application.Current.Resources["i_max4"];

            j_max1 = (int)Application.Current.Resources["j_max1"];
            j_max2 = (int)Application.Current.Resources["j_max2"];
            j_max3 = (int)Application.Current.Resources["j_max3"];
            j_max4 = (int)Application.Current.Resources["j_max4"];
        ...
        private void cllear_Click(object sender, RoutedEventArgs e)
        {
